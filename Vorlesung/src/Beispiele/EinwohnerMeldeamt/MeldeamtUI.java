package Beispiele.EinwohnerMeldeamt;
...
public class MeldeamtUI extends JFrame {
		...
		ActionListener btnListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(action.equals(ACTION_ADD)){
					...
					boolean erg = Listenoperationen.hinzufuegen(tfName.getText(), 
																tfVorname.getText(), 
																tfGebName.getText(), 
																tfEmail.getText(), 
					...
					if(erg){
						lblNotifications.setText("Einwohner " + tfName.getText() + " erfolgreich hinzugefügt!");
					}else{
						lblNotifications.setText("Einwohner " + tfName.getText() + " NICHT erfolgreich hinzugefügt!");
					}
				}else if(action.equals(ACTION_SHOW)){
					boolean erg = Listenoperationen.anzeigen(tfName.getText(), tfVorname.getText());
					if(erg){
						lblNotifications.setText("Einwohner " + tfName.getText() + " angezeigt!");
					}else{
						lblNotifications.setText("Einwohner " + tfName.getText() + " NICHT angezeigt!");
					}
				}else if(action.equals(ACTION_SEARCH)){
					boolean erg = Listenoperationen.suchen(tfName.getText(), tfVorname.getText());
					if(erg){
						lblNotifications.setText("Einwohner " + tfName.getText() + " gefunden!");
					}else{
						lblNotifications.setText("Einwohner " + tfName.getText() + " NICHT gefunden!");
					}
				}else if(action.equals(ACTION_DELETE)){
					boolean erg = Listenoperationen.loeschen(tfName.getText(), tfVorname.getText());
					if(erg){
						lblNotifications.setText("Einwohner " + tfName.getText() + " gelöscht!");
					}else{
						lblNotifications.setText("Einwohner " + tfName.getText() + " NICHT gefunden!");
					}
	...
	// Center Panel - Eingabebereich
		...
		JRadioButton rbtVH = new JRadioButton(Einwohner.FAMILIENSTAND_VERHEIRATET);
		...
		maritalGroup.add(rbtL); rbtL.addActionListener(rbgMaritalStatus);
		maritalGroup.add(rbtVH); rbtVH.addActionListener(rbgMaritalStatus);
		maritalGroup.add(rbtVW); rbtVW.addActionListener(rbgMaritalStatus);
		maritalGroup.add(rbtG); rbtG.addActionListener(rbgMaritalStatus);
